...
export function LoginAsSystemAdminSwagger() {
  return applyDecorators(
    ApiOperation({
      ...
      description: 'Authenticate a system admin and receive access and refresh tokens',
    }),
        ...
        'application/json': {
          ...
          examples: {
            ...
            EmailRequired: {
              ...
              value: { errors: [{ message: 'email should not be empty' }] },
            },
            PasswordRequired: {
              summary: 'Password is required',
              value: { errors: [{ message: 'password should not be empty' }] },
            },
          },
        },
      },
